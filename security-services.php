...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!-- Page Banner Start -->
        <div class="section page-banner-section" style="background-image: url(assets/images/custom/service-banner.jpg);">
            <div class="shape-1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner text-center">
                                <h2 class="title">Security Services</h2>
                                <ul class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#">Services</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Security Services</li>
                                </ul>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-8 offset-2">
                        <p>
                        Protecting your organization’s IT infrastructure from cyber threats is of paramount importance. Our IT security services encompass a comprehensive range of solutions to safeguard your systems and data. We employ advanced threat detection and response mechanisms to identify and mitigate potential security breaches. Our vulnerability management services involve regular assessments and penetration testing to identify weaknesses in your infrastructure and address them proactively. We work with you to develop and implement robust security policies and procedures, ensuring compliance with industry standards and regulations. Additionally, we offer security awareness training to educate your employees about best practices and potential risks.
                        </p>
                    </div>
                </div>
